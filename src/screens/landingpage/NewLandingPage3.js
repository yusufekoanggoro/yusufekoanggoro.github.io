                        ...
                        <Element name="About" className="about-wrap">
                            ...
                            <div className='desc'>
                                <p style={{textAlign: 'justify', textJustify: 'inter-word'}}>
                                    <strong>Hi, I'm Yusuf Eko Anggoro</strong>, a <strong>Back-End Developer</strong> with <strong>5+ years of experience</strong> in developing, and maintaining scalable systems. I have a <strong>strong passion for coding</strong> and a deep enthusiasm for <strong>continuous learning</strong>, especially in the <strong>latest technologies</strong>. My <strong>expertise</strong> includes <strong>Node.js, TypeScript, and Golang</strong> for back-end development in a <strong>microservices architecture</strong>.
                                </p>
                            </div>
                            <div>
                                ...
                                >
                                    ...
                                    <p>
                                        <ul className="ul-vertical-timeline-content">
                                            ...
                                            <li>Used the ELK Stack (Elasticsearch, Logstash, Kibana) to monitor and analyze logs, based on configurations set by the DevOps team.</li>
